...
const navigation = [
  ...
  { name: "Feedback", href: "#", icon: ChatAlt2Icon, current: false },
  { name: "Training", href: "#", icon: BookOpenIcon, current: false },
  { name: "Exam", href: "#", icon: ClipboardCheckIcon, current: false }
];
